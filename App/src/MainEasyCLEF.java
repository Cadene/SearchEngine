...
public class MainEasyCLEF {
	...
	public static void main(String[] args) throws Exception {
		...
		IRModel pageRank = new IRWithRandomWalk(weighterLangue, modelLangue, new PageRank(.1, 500), index.getPred(), index.getSucc(), 10, 5);
		...
		IRModel modelHITS = new IRWithRandomWalk(weighterLangue, modelLangue, new HITS(1000), index.getPred(), index.getSucc(), 10, 5);
		...
		list.add(new FeaturerModel(modelVectLogtfidfLogtfidf2));
		...
		MetamodelLineaire modelLineaire = new MetamodelLineaire(weighterLineaire, stemmer, featurer, 1000000, 0.000001, 0);
		...
		for (double d: modelLineaire.getWeights()){
